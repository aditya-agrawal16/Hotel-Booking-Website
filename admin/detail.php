  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <button type="button" class="btn" id="back">Update</button>
            ...
            <table class="table table-striped">
			  ...
			  $result = mysqli_query($conn,"Select * from booking where booking_id=".$_GET['booking']."");
				if( mysqli_num_rows($result) >0){
					...
					print "<td>";
					$q = mysqli_query($conn,"SELECT roombook.totalroombook AS total, room.room_name AS name
																FROM roombook
					...
					print "				<td>Rs ".$rows['total_amount']."</td></tr>\n";
					print "				<tr><td>Deposit</td>\n";
					print "				<td>Rs ".$rows['deposit']."</td></tr>\n";
					print "				<tr><td>Balance</td>\n";
					print "				<td>Rs ".($rows['total_amount']-$rows['deposit'])."</td></tr>\n";
