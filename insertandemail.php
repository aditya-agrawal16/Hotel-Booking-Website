...
mysqli_query($conn,"INSERT INTO `roombook` (`booking_id`, `room_id`, `totalroombook`, `id`) VALUES ('".$_SESSION['booking_id']."', '".$value0."', '".$_SESSION['roomqty'][$count]."', NULL);");
$count = $count+1;
} ;
...
$message .="															<td  style=\"width:200px;\"> <b>Rs ".$_SESSION['ind_rate'][$count]."</b></td>\n";
$message .="														</tr>\n";
$count = $count+1;
} ;
...
$message .="															<td  style=\"width:200px;\"> <b>Rs ".$_SESSION['total_amount']."</b></td>\n";
$message .="														</tr>\n";
$message .="														<tr>\n";
$message .="															<td style=\"width:200px;\">15% Deposit Due</td>\n";
$message .="															<td  style=\"width:200px;\"><b>Rs ".$_SESSION['deposit']."</b></td>\n";
$message .="														</tr>\n";;
$message .="														\n";
$message .="													</table>\n";
...
$message .="								<tr>\n";
$message .="									<td>\n";
$message .="										<br><br>Hotel Address, Hotel Street address, Vellore, India\n";
$message .="									</td>\n";
$message .="								</tr>\n";
$message .="							</table>\n";
$message .="						</td>\n";
...
$message .="						<tr>\n";
$message .="							<td><br>Questions? Email <a href=\"mailto:\">adityaagrawal1216@gmail.com or Call Us at 9876543210</a></td>\n";
$message .="						</tr>\n";
$message .="					</table>\n";
$message .="				</div></div>\n";
$message .="		</td>\n";
...
$message .="</body></html>";
$headers  ="From: adityaagrawal1216@gmail.com";
